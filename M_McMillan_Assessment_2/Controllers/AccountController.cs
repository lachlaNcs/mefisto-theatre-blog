        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new Member
                {
                    ...
                    // Record the date and time when the User registered
                    RegisteredAt = DateTime.Now,
                    // When the User Registers they are active and not suspended
                    IsActive = true,
                    IsSuspended = false
                };
                ...
                if (result.Succeeded)
                {
                    // This adds all registering Users to the Member Role
